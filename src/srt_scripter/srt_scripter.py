...
class SrtScripter():
    ...
    """
    def __init__(self):
        self.argparser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    def add_parser_arguments(self):
        ...
        """
        self.argparser.add_argument("-o", "--output", type=str, default="script.cmd",
            help="The script file name generated by the scripter.")
        self.argparser.add_argument("-r", "--rad", type=str, default="",
            help="Name of the .rad file where the script with write the measured data.")
        self.argparser.add_argument("-f", "--freq", type=int, default=1420,
            help="Center frequency for calibration and measurements.")
        self.argparser.add_argument("-m", "--mode", type=int, default=1, choices=range(1,5),
            help="Receptor mode. Mode 1: default bandwidth 500kHz, Mode 2: bw=250kHz, Mode 3: bw=125kHz, Mode 4: bw=3x500kHz, Mode 5: scanmode")
        self.argparser.add_argument("-ca", "--cal_az", type=float, default=200,
            help="Azimuth position for calibration.")
        self.argparser.add_argument("-ce", "--cal_el", type=float, default=30,
